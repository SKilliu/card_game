...
type HTTP struct {
	Host           string `env:"CARD_GAME_API_HOST,required"`
	Port           string `env:"CARD_GAME_API_PORT,required"`
	SSL            bool   `env:"CARD_GAME_API_SSL,required"`
	ServerCertPath string `env:"CARD_GAME_API_CERT_PATH" envDefault:""`
	ServerKeyPath  string `env:"CARD_GAME_API_CERT_KEY" envDefault:""`
}
